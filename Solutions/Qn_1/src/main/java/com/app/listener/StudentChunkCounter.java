...
public class StudentChunkCounter implements ChunkListener {

	private static final Logger log = LoggerFactory.getLogger(StudentChunkCounter.class);
	...
	public void afterChunk(ChunkContext context) {
		...
		System.out.println("Total Items written into DB: " + writeCount);
